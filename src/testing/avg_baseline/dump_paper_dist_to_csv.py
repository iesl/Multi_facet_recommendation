...
#agg_method = 'max'
#agg_method = 'avg'
#input_file = '/iesl/canvas/hschang/recommendation/Multi_facet_recommendation//gen_log/NeurIPS2019_'+agg_method+'_cbow_freq_4_dist.np'
#input_2_file = '/iesl/canvas/hschang/recommendation/Multi_facet_recommendation//gen_log/NeurIPS2019_rec_test_trans_bsz50_n1_shuffle_uni_max_lr2e-4__sim_w_freq_no_lin_auto_avg1_alldrop01_bid_score.np'
#output_file = '/iesl/canvas/hschang/recommendation/Multi_facet_recommendation/gen_log/to_NeurIPS2019/cbow_'+agg_method+'_agg_single_sim.csv'
#input_2_file = '/iesl/canvas/hschang/recommendation/Multi_facet_recommendation//gen_log/NeurIPS2019_rec_test_trans_bsz50_n1_shuffle_uni_max_lr2e-4__w_freq_single_stable_auto_avg1_alldrop01_bid_score.np'
#output_file = '/iesl/canvas/hschang/recommendation/Multi_facet_recommendation/gen_log/to_NeurIPS2019/cbow_'+agg_method+'_agg_single.csv'
#input_2_file = '/iesl/canvas/hschang/recommendation/Multi_facet_recommendation//gen_log/NeurIPS2019_rec_test_trans_bsz50_n5_shuffle_uni_max_lr2e-4__w_freq_single_stable_auto_avg1_alldrop01_bid_score.np'
#output_file = '/iesl/canvas/hschang/recommendation/Multi_facet_recommendation/gen_log/to_NeurIPS2019/cbow_'+agg_method+'_agg_multi.csv'
