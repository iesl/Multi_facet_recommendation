...
def load_w_ind(f_in, max_sent_num, max_sent_len):
    ...
    return w_ind_feature, w_ind_target
...
with open(corpus_input_name) as f_in:
    w_ind_feature, w_ind_target = load_w_ind(f_in, args.max_sent_num, args.max_sent_len)

corpus_size = len(w_ind_feature)
#args.max_target_num+args.max_sent_len
print("Allocating {} bytes".format( corpus_size*(max_target_num+args.max_sent_len)*4 ) )
