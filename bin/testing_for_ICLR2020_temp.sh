...
#MODEL_PATH="./models/gorc_fix-20200722-104407"
#OUR_SIM="./gen_log/${DATASET}_trans_n1.np"
#OUR_SIM="./gen_log/${DATASET}_trans_n5_avg_train.np"
OUR_SIM="./gen_log/${DATASET}_trans_n5_max_norm1.np"
CBOW_FILE="/dev/null"
echo "running our methods"
#eval $PY_PATH src/main.py --batch_size 50 --save $MODEL_PATH --de_output_layer single_dynamic --continue_train --data $DATA_FOLDER --source_emb_file $CBOW_FILE --de_model TRANS --en_model TRANS --encode_trans_layers 3 --trans_layers 3 --n_basis 1 --seed 111 --epochs 100 --tensor_folder tensors_cold --coeff_opt max --tag_w 0 --user_w 5 --rand_neg_method shuffle --target_norm True --loss_type dist --inv_freq_w True --de_coeff_model TRANS_old --lr 0.0002 --target_emsize 100 --freeze_encoder_decoder True --loading_target_embedding False --always_save_model True --target_embedding_suffix _${DATASET}_test_neg1 --log_file_name log_${DATASET}_test.txt --neg_sample_w 1
#eval $PY_PATH src/main.py --batch_size 50 --save $MODEL_PATH --de_output_layer single_dynamic --continue_train --data $DATA_FOLDER --source_emb_file $CBOW_FILE --de_model TRANS --en_model TRANS --encode_trans_layers 3 --trans_layers 3 --n_basis 5 --seed 111 --epochs 100 --tensor_folder tensors_cold --coeff_opt max --tag_w 0 --user_w 5 --rand_neg_method shuffle --target_norm True --loss_type dist --inv_freq_w True --de_coeff_model TRANS_old --lr 0.0002 --target_emsize 100 --freeze_encoder_decoder True --loading_target_embedding False --always_save_model True --target_embedding_suffix _${DATASET}_test_neg0 --log_file_name log_${DATASET}_test.txt --neg_sample_w 0


#eval $PY_PATH src/recommend_test.py --checkpoint $MODEL_PATH --outf $OUR_SIM --tag_emb_file tag_emb_${DATASET}_test_always.pt --user_emb_file user_emb_${DATASET}_test_neg0_always.pt --batch_size 50 --n_basis 5 --data $DATA_FOLDER --tensor_folder tensors_cold --coeff_opt max --loss_type dist --test_tag False --source_emsize 200 --en_model TRANS --encode_trans_layers 3 --trans_layers 3 --de_coeff_model TRANS_old --de_output_layer single_dynamic --store_dist user
#eval $PY_PATH src/recommend_test.py --checkpoint $MODEL_PATH --outf $OUR_SIM --tag_emb_file tag_emb_${DATASET}_test_always.pt --user_emb_file user_emb_${DATASET}_test_neg0_always.pt --batch_size 50 --n_basis 1 --data $DATA_FOLDER --tensor_folder tensors_cold --coeff_opt max --loss_type dist --test_tag False --source_emsize 200 --en_model TRANS --encode_trans_layers 3 --trans_layers 3 --de_coeff_model TRANS_old --de_output_layer single_dynamic --store_dist user


#eval $PY_PATH src/recommend_test.py --checkpoint $MODEL_PATH --outf $OUR_SIM --tag_emb_file tag_emb_${DATASET}_test_always.pt --user_emb_file user_emb_${DATASET}_test_neg0_always.pt --batch_size 50 --n_basis 5 --data $DATA_FOLDER --tensor_folder tensors_cold --coeff_opt avg --loss_type dist --test_tag False --source_emsize 200 --en_model TRANS --encode_trans_layers 3 --trans_layers 3 --de_coeff_model TRANS_old --de_output_layer single_dynamic --store_dist user 
#eval $PY_PATH src/recommend_test.py --checkpoint $MODEL_PATH --outf $OUR_SIM --tag_emb_file tag_emb_${DATASET}_test_always.pt --user_emb_file user_emb_${DATASET}_test_neg0_always.pt --batch_size 50 --n_basis 5 --data $DATA_FOLDER --tensor_folder tensors_cold --coeff_opt max_norm_1 --loss_type dist --test_tag False --source_emsize 200 --en_model TRANS --encode_trans_layers 3 --trans_layers 3 --de_coeff_model TRANS_old --de_output_layer single_dynamic --store_dist user 
#eval $PY_PATH src/recommend_test.py --checkpoint $MODEL_PATH --outf $OUR_SIM --tag_emb_file tag_emb_${DATASET}_test_always.pt --user_emb_file user_emb_${DATASET}_test_neg1_always.pt --batch_size 50 --n_basis 5 --data $DATA_FOLDER --tensor_folder tensors_cold --coeff_opt max_norm_1 --loss_type dist --test_tag False --source_emsize 200 --en_model TRANS --encode_trans_layers 3 --trans_layers 3 --de_coeff_model TRANS_old --de_output_layer single_dynamic --store_dist user 
#eval $PY_PATH src/recommend_test.py --checkpoint $MODEL_PATH --outf $OUR_SIM --tag_emb_file tag_emb_${DATASET}_test_always.pt --user_emb_file user_emb_${DATASET}_test_neg1_always.pt --batch_size 50 --n_basis 1 --data $DATA_FOLDER --tensor_folder tensors_cold --coeff_opt max_norm_1 --loss_type dist --test_tag False --source_emsize 200 --en_model TRANS --encode_trans_layers 3 --trans_layers 3 --de_coeff_model TRANS_old --de_output_layer single_dynamic --store_dist user
...
MERGE_ALPHA=0
#MERGE_ALPHA=1
#OUTPUT_CSV="gen_log/${DATASET}_specter_ours_sim_neg0_always1.csv"
#OUTPUT_CSV="gen_log/${DATASET}_ours_sim_rand_neg1_always1.csv"
OUTPUT_CSV="gen_log/${DATASET}_ours_sim_rand_neg0_always1_n5.csv"
#OUTPUT_CSV="gen_log/${DATASET}_ours_sim_rand_neg0_always1_n5_avg_test.csv"
...
#eval $PY_PATH src/main.py --batch_size 50 --save $MODEL_PATH --de_output_layer single_dynamic --continue_train --data $DATA_FOLDER --source_emb_file $CBOW_FILE --de_model TRANS --en_model TRANS --encode_trans_layers 3 --trans_layers 3 --n_basis 5 --seed 111 --epochs 100 --tensor_folder tensors_cold --coeff_opt avg --tag_w 0 --user_w 5 --rand_neg_method shuffle --target_norm True --loss_type dist --inv_freq_w True --de_coeff_model TRANS_old --lr 0.0002 --target_emsize 100 --freeze_encoder_decoder True --loading_target_embedding False --always_save_model True --target_embedding_suffix _${DATASET}_test_neg0 --log_file_name log_${DATASET}_test.txt --neg_sample_w 0
