...
#~/anaconda3/bin/python src/testing/sim/STS_eval.py -t ./gen_log/STS_train_wiki2016_word2vec_trans_n10_bsz200_ep2_0.json -w ./resources/word2vec_wiki2016_min100.txt -d $DICT_UPPER -g $STSB_TRAIN -m save -p ./gen_log/pc/pc_word2vec_sts_train_n10 > eval_log/STS_train_wiki2016_word2vec_trans_n10_bsz200_ep2_0
#~/anaconda3/bin/python src/testing/sim/STS_eval.py -t ./gen_log/STS_dev_wiki2016_word2vec_trans_n10_bsz200_ep2_0.json -w ./resources/word2vec_wiki2016_min100.txt -d $DICT_UPPER -g $STSB_DEV -m load -p ./gen_log/pc/pc_word2vec_sts_train_n10 > eval_log/STS_dev_wiki2016_word2vec_trans_n10_bsz200_ep2_0
~/anaconda3/bin/python src/testing/sim/STS_eval.py -t ./gen_log/STS_test_wiki2016_word2vec_trans_n10_bsz200_ep2_0.json -w ./resources/word2vec_wiki2016_min100.txt -d $DICT_UPPER -g $STSB_TEST -m load -p ./gen_log/pc/pc_word2vec_sts_train_n10 > eval_log/STS_test_wiki2016_word2vec_trans_n10_bsz200_ep2_0
