...
OUTPUT_NAME=NeurIPS2019_bid_score_scibert
#INPUT_NAME=ICLR2018_bid_score
#OUTPUT_NAME=ICLR2018_bid_score_scibert
#INPUT_NAME=ICLR2019_bid_score
#OUTPUT_NAME=ICLR2019_bid_score_scibert
#INPUT_NAME=ICLR2020_bid_score
#OUTPUT_NAME=ICLR2020_bid_score_scibert
#INPUT_NAME=UAI2019_bid_score
#OUTPUT_NAME=UAI2019_bid_score_scibert
#echo $MIN_FREQ
...
INPUT_FILE_TEST_ALL="./data/raw/openreview/$INPUT_NAME/all_submission_bid_data_scibert"
