...
MODEL_PATH="./models/gorc-20200419-025712" ; LOG_SUFFIX="_sim_no_lin_auto1_alldrop01" ; N_BASIS="1" ; DE_OUT="no" ; LOSS_TYPE="sim"
#MODEL_PATH="./models/gorc-20200419-010034" ; LOG_SUFFIX="_sim_no_lin_auto1_alldrop01" ; N_BASIS="5" ; DE_OUT="no" ; LOSS_TYPE="sim"
...
#MODEL_PATH="./models/gorc-20200419-170306" ; LOG_SUFFIX="_sim_w_freq_no_lin_auto5_alldrop01" ; N_BASIS="1" ; DE_OUT="no" ; LOSS_TYPE="sim"
#MODEL_PATH="./models/gorc-20200419-170149" ; LOG_SUFFIX="_sim_w_freq_no_lin_auto5_alldrop01" ; N_BASIS="5" ; DE_OUT="no" ; LOSS_TYPE="sim"

if [ $LOSS_TYPE == "dist" ]; then
    LOSS_ARG="--target_norm True --loss_type dist"
    DE_COEFF="TRANS_old"
else
    LOSS_ARG="--target_norm False --loss_type sim"
    DE_COEFF="TRANS_two_heads"
fi


#Link prediction
~/anaconda3/bin/python src/recommend_test.py --checkpoint $MODEL_PATH --outf ./gen_log/gorc_rec_test_trans_bsz50_n${N_BASIS}_shuffle_uni_max_lr2e-4_$LOG_SUFFIX --de_output_layer ${DE_OUT}_dynamic --batch_size 10 --n_basis $N_BASIS --data ./data/processed/gorc_uncased_min_5 --tensor_folder tensors_cold_0 --coeff_opt max --loss_type $LOSS_TYPE --test_tag True --source_emsize 200 --encode_trans_layers 3 --trans_layers 3 --de_coeff_model $DE_COEFF > ./eval_log/gorc_rec_test_trans_bsz200_n1_shuffle_uni_max_lr2e-4_$LOG_SUFFIX
