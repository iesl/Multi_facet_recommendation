...
#~/anaconda3/bin/python src/main.py --coeff_opt lc --batch_size 200 --optimizer Adam --lr 0.00001 --save ./models/wiki2016 --data ./data/processed/wiki2016_min500/ --emb_file ./resources/glove.840B.300d_filtered_wiki2016.txt
...
#~/anaconda3/bin/python src/main.py --coeff_opt lc --batch_size 200 --optimizer Adam --lr 0.00001 --save ./models/wiki2016 --data ./data/processed/wiki2016_min500/ --emb_file ./resources/glove.840B.300d_filtered_wiki2016.txt --update_target_emb
