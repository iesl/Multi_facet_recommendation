...
#~/anaconda3/bin/python src/main.py --coeff_opt lc --batch_size 200 --save ./models/wiki2016 --data ./data/processed/wiki2016_min100/ --emb_file ./resources/glove.840B.300d_filtered_wiki2016.txt --de_model LSTM+TRANS
